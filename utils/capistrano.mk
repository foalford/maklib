...
latest_obsoleted_dirname := $$(shell ls -1 $$(dir_r) | sed -n '/[0-9]\+/p' | sort  -n |tail -$(NUM_PRESERVE_RLS) |head -1)
deploy_path = $$(dir_r)/$$(new_dirname)


# Create symlink rules
$$(foreach F, $$(symlink_objs), $$(eval $$(__create_symlink)))
